unit AnsiStringReplaceJOHIA32Unit18;
...
function StringReplace_JOH_IA32_18(const Str, Old, New: AnsiString;
...
{Size = 628 Bytes + 256 Byte Lookup Table + 4 Byte Code Page = 888 Bytes}
function StringReplace_JOH_IA32_18(const Str, Old, New: AnsiString;
                                   Flags: TReplaceFlags): AnsiString;
const
...
var
  ...
  asm
    ...
    lea    esi, AnsiUpcase       {Uppercase Lookup Table}
