...
procedure MakeContextsAES_DKC_PAS_32(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_32a(var Block);
procedure DecryptAES_DKC_PAS_32a(var Block);
procedure EncryptAES_DKC_PAS_32b(var Block);
procedure DecryptAES_DKC_PAS_32b(var Block);
 ...
 for I := 1 to pDKCContext1.Rounds-1 do
  begin
   ...
   B3 := AES_T0[S3 and $ff] xor
         ...
         AES_T3[S2 shr 24];
   S0 := B0 xor pDKCContext1.RoundKeys.W[Icardinal].dw;
   S1 := B1 xor pDKCContext1.RoundKeys.W[Icardinal+1].dw;
   S2 := B2 xor pDKCContext1.RoundKeys.W[Icardinal+2].dw;
   S3 := B3 xor pDKCContext1.RoundKeys.W[Icardinal+3].dw;
   Inc(Icardinal,4);
  end;
