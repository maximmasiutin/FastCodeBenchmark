...
procedure MakeContextsAES_DKC_PAS_30(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_30a(var Block);
procedure DecryptAES_DKC_PAS_30a(var Block);
procedure EncryptAES_DKC_PAS_30b(var Block);
procedure DecryptAES_DKC_PAS_30b(var Block);
