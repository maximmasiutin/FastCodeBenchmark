...
procedure MakeContextsAES_DKC_PAS_34(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_34(var Block);
procedure DecryptAES_DKC_PAS_34(var Block);
