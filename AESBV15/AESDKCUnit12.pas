...
procedure MakeContextsAES_DKC_PAS_29(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_29(var Block);
procedure DecryptAES_DKC_PAS_29(var Block);
...
begin
 ...
 for I := 1 to pDKCContext1.Rounds-1 do
  begin
   ...
   Inc(Icardinal,4);
   TAESVectors(pBlock^)[0].dw := E6[0].DW;
   TAESVectors(pBlock^)[1].dw := E6[1].DW;
   TAESVectors(pBlock^)[2].dw := E6[2].DW;
   TAESVectors(pBlock^)[3].dw := E6[3].DW;
  end;
 E5[0].bt[0] := AESSBox[E6[0].DW and $ff];
 E5[0].bt[1] := AESSBox[E6[1].DW shr 8 and $ff];
 E5[0].bt[2] := AESSBox[E6[2].DW shr 16 and $ff];
 E5[0].bt[3] := AESSBox[E6[3].DW shr 24 and $ff];
 E5[1].bt[0] := AESSBox[E6[1].DW and $ff];
 E5[1].bt[1] := AESSBox[E6[2].DW shr 8 and $ff];
 E5[1].bt[2] := AESSBox[E6[3].DW shr 16 and $ff];
 E5[1].bt[3] := AESSBox[E6[0].DW shr 24 and $ff];
 E5[2].bt[0] := AESSBox[E6[2].DW and $ff];
 E5[2].bt[1] := AESSBox[E6[3].DW shr 8 and $ff];
 E5[2].bt[2] := AESSBox[E6[0].DW shr 16 and $ff];
 E5[2].bt[3] := AESSBox[E6[1].DW shr 24 and $ff];
 E5[3].bt[0] := AESSBox[E6[3].DW and $ff];
 E5[3].bt[1] := AESSBox[E6[0].DW shr 8 and $ff];
 E5[3].bt[2] := AESSBox[E6[1].DW shr 16 and $ff];
 E5[3].bt[3] := AESSBox[E6[2].DW shr 24 and $ff];
 P1 := @E5;
 ...
 for I := pDKCContext2.Rounds-1 downto 1 do
  begin
   ...
   TAESVectors(pBlock^)[3].dw := AES_InvT4[S3 and $ff] xor
                                 ...
                                 AES_InvT7[S0 shr 24];
   Dec(P2,3);
   S0 := TAESVectors(pBlock^)[0].dw xor P2^;
   Inc(P2);
   S1 := TAESVectors(pBlock^)[1].dw xor P2^;
   Inc(P2);
   S2 := TAESVectors(pBlock^)[2].dw xor P2^;
   Inc(P2);
   S3 := TAESVectors(pBlock^)[3].dw xor P2^;
   Dec(P2,4);
