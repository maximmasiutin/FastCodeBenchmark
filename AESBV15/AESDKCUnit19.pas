...
procedure MakeContextsAES_DKC_PAS_36(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_36(var Block);
procedure DecryptAES_DKC_PAS_36(var Block);
