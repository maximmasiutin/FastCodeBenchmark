...
procedure MakeContextsAES_DKC_PAS_35(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_35(var Block);
procedure DecryptAES_DKC_PAS_35(var Block);
