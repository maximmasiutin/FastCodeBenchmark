...
procedure MakeContextsAES_DKC_PAS_42(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_42(var Block);
procedure DecryptAES_DKC_PAS_42(var Block);
