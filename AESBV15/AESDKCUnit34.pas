...
procedure MakeContextsAES_DKC_SSE2_4(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_SSE2_4(var Block);
procedure DecryptAES_DKC_SSE2_4(var Block);
