...
procedure MakeContextsAES_DKC_PAS_31(const Key; KeySize : Cardinal);
procedure EncryptAES_DKC_PAS_31a(var Block);
procedure DecryptAES_DKC_PAS_31a(var Block);
procedure EncryptAES_DKC_PAS_31b(var Block);
procedure DecryptAES_DKC_PAS_31b(var Block);
...
begin
 ...
 E5[0].bt[0] := AESSBox[S0 and $ff];
 E5[0].bt[1] := AESSBox[S1 shr 8 and $ff];
 E5[0].bt[2] := AESSBox[S2 shr 16 and $ff];
 E5[0].bt[3] := AESSBox[S3 shr 24];
 E5[1].bt[0] := AESSBox[S1 and $ff];
 E5[1].bt[1] := AESSBox[S2 shr 8 and $ff];
 E5[1].bt[2] := AESSBox[S3 shr 16 and $ff];
 E5[1].bt[3] := AESSBox[S0 shr 24];
 E5[2].bt[0] := AESSBox[S2 and $ff];
 E5[2].bt[1] := AESSBox[S3 shr 8 and $ff];
 E5[2].bt[2] := AESSBox[S0 shr 16 and $ff];
 E5[2].bt[3] := AESSBox[S1 shr 24];
 E5[3].bt[0] := AESSBox[S3 and $ff];
 E5[3].bt[1] := AESSBox[S0 shr 8 and $ff];
 E5[3].bt[2] := AESSBox[S1 shr 16 and $ff];
 E5[3].bt[3] := AESSBox[S2 shr 24];
 P1 := @E5;
...
var
 ...
 P1, P2, P3 : ^Cardinal;
 I : Integer;
 S0, S1, S2, S3, C0, C1, C2, C3, B0, B1, B2, B3 : Cardinal;
