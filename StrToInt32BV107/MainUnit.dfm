object MainForm: TMainForm
  Left = -1
  Top = 77
  Caption = 'StrToInt32 B&V for Fastcode Version 1.0.7'
  ClientHeight = 694
  ClientWidth = 1022
  Color = clBtnFace
  ...
  object FasterValidationCheckBox: TCheckBox
    Left = 24
    Top = 328
    Width = 97
    Height = 17
    Hint = 'Faster validation, but not fast ;-)'
    Caption = 'Faster Validation'
    ParentShowHint = False
    ShowHint = True
    TabOrder = 25
  end
