...
uses
 ComplexDataTypesUnit, RegtAddDKCUnit, RegtAddDFLUnit, Math, RectAdd_JOH;
...
const
 ...
 VALIDATEEXTENDED2STEPSIZE : Extended = 1E150;
 VALIDATEDOUBLE2STEPSIZE : Double = 1E15;
 VALIDATESINGLE2STEPSIZE : Single = 15E1;
...
type
 TRegtAddExtendedFunction = function (const X, Y : TRegtangularComplexE) : TRegtangularComplexE;
 TRegtAddDoubleFunction = function (const X, Y : TRegtangularComplexD) : TRegtangularComplexD;
 TRegtAddSingleFunction = function (const X, Y : TRegtangularComplexS) : TRegtangularComplexS;
...
var
 ...
 RegtAddExtendedFunction : TRegtAddExtendedFunction;
 RegtAddDoubleFunction : TRegtAddDoubleFunction;
 RegtAddSingleFunction : TRegtAddSingleFunction;
...
begin
 ...
 Y.ImaginaryPart := 3;
 Z := RegtAddExtendedFunction(X, Y);
 if not ((Z.RealPart = 2) and (Z.ImaginaryPart = 4)) then
  begin
   Result := False;
  end;
end;
     ...
     while X.ImaginaryPart < MAXEXTENDED / VALIDATEEXTENDED2STEPSIZE do
      begin
       ...
       while X.RealPart < MAXEXTENDED / VALIDATEEXTENDED2STEPSIZE do
        begin
         Z1 := RegtAddDKCPas1(X, Y);
         Z2 := RegtAddExtendedFunction(X, Y);
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtAddExtendedFunction);
  ...
  ValidateExtendedButton.Caption := 'Validate';
 except
  ReportRichEdit.Lines.Add(FunctionName
                    + #9 + 'Extended'
                    + #9 + FunctionAddressString[8]
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub1BenchmarkArray[I5]
        := RegtAddExtendedFunction(ExtendedSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub1BenchmarkArray[I5]
        := RegtAddDoubleFunction(DoubleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub1BenchmarkArray[I5]
        := RegtAddSingleFunction(SingleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub2BenchmarkArray[I5]
        := RegtAddExtendedFunction(ExtendedSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub2BenchmarkArray[I5]
        := RegtAddDoubleFunction(DoubleSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub2BenchmarkArray[I5]
        := RegtAddSingleFunction(SingleSrc1Sub2BenchmarkArray[I5],
...
begin
 case ExtendedFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtAddExtendedFunction := RegtAddDKCPas1;
  1 : RegtAddExtendedFunction := RegtAddDFL_IA32_1;
  2 : RegtAddExtendedFunction := RegtAddDFL_IA32_2;
  3 : RegtAddExtendedFunction := RectAdd_JOH_IA32;
 else
...
begin
 ...
 SaveDialog.FileName := 'ComplexRegtAddBenchReport.Txt';
...
begin
 ReportRichEdit.Print('Complex number addition Report');
end;
...
begin
 case DoubleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtAddDoubleFunction := RegtAddDKCPas1;
  1 : RegtAddDoubleFunction := RegtAddDKCIA32_1;
  2 : RegtAddDoubleFunction := RegtAddDDKC_SSE2_1;
  3 : RegtAddDoubleFunction := RegtAddDFL_IA32_1;
  4 : RegtAddDoubleFunction := RectAdd_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 case SingleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtAddSingleFunction := RegtAddDKCPas1;
  1 : RegtAddSingleFunction := RegtAddDKCIA32_1;
  2 : RegtAddSingleFunction := RegtAddDDKC_SSE_1;
  3 : RegtAddSingleFunction := RegtAddDFL_IA32_1;
  4 : RegtAddSingleFunction := RectAdd_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtAddDoubleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
  ...
  ValidateDoubleButton.Caption := 'Validate';
 except
  ReportRichEdit.Lines.Add(FunctionName
                    + #9 + 'Double'
                    + #9 + FunctionAddressString[8]
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtAddSingleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
  ...
  ValidateSingleButton.Caption := 'Validate';
 except
  ReportRichEdit.Lines.Add(FunctionName
                    + #9 + 'Single'
                    + #9 + FunctionAddressString[8]
