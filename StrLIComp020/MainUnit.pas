...
uses
 FastcodeCPUID, SystemInfoUnit, StrLICompRTLUnit, StrLICompJOHUnit;

{$R *.dfm}

type
 TStrLICompFunction = function (const Str1, Str2: PChar; MaxLen: Cardinal): Integer;

var
 StrLICompFunction : TStrLICompFunction;
...
begin
 ...
 for I3 := 0 to 2 do
   begin
     I1 := StrLIComp(Str1, Str2, I3);
     I2 := StrLICompFunction(Str1, Str2, I3);
  ...
  begin
   for J2 := 0 to 255 do
    begin
     ...
     for I3 := 0 to 87 do
       begin
         I1 := StrLIComp(Str1, Str2, I3*3);
         I2 := StrLICompFunction(Str1, Str2, I3*3);
         if Sign(I1) <> Sign(I2) then
          begin
           Result := False;
           Exit;
            ...
            begin
             for J7 := 0 to 255 do
              begin
               ...
               Str1Array[6] := Char(J1);
               I3 := 0;
               I1 := StrLICompFunction(Str1, Str1, I3);
               if I1 <> 0 then
                begin
                 Result := False;
                 Exit;
      ...
      begin
       ...
       for I2 := 1 to SUBBENCH1STRARRAYSIZE-2 do
        begin
         ...
         I3 := 1;
         J1 := StrLICompFunction(Str1, Str2, I3);
         J2 := StrLICompFunction(Str2, Str1, I3);
         I3 := 10;
         StrLICompFunction(Str1, Str2, I3);
         StrLICompFunction(Str2, Str1, I3);
         I3 := 100;
         StrLICompFunction(Str1, Str2, I3);
         StrLICompFunction(Str2, Str1, I3);
        end;
      ...
      begin
       ...
       for I3 := 0 to SUBBENCH2STRARRAYSIZE-1 do
        begin
         ...
         I4 := 1;
         J1 := StrLICompFunction(Str1, Str2, I4);
         J2 := StrLICompFunction(Str2, Str1, I4);
         I4 := 10;
         StrLICompFunction(Str1, Str2, I4);
         StrLICompFunction(Str2, Str1, I4);
         I4 := 50;
         StrLICompFunction(Str1, Str2, I4);
         StrLICompFunction(Str2, Str1, I4);
         I4 := 100;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@StrLICompFunction);
...
begin
 case FunctionSelectionRadioGroup.ItemIndex+1 of
    1 : StrLICompFunction := StrLIComp_RTL_a;
    2 : StrLICompFunction := StrLIComp_RTL_b;
    3 : StrLICompFunction := StrLIComp_RTL_c;
    4 : StrLICompFunction := StrLIComp_RTL_d;
    5 : StrLICompFunction := StrLIComp_JOH_PAS_1_a;
    6 : StrLICompFunction := StrLIComp_JOH_PAS_1_b;
    7 : StrLICompFunction := StrLIComp_JOH_PAS_1_c;
    8 : StrLICompFunction := StrLIComp_JOH_PAS_1_d;
    9 : StrLICompFunction := StrLIComp_JOH_IA32_1_a;
   10 : StrLICompFunction := StrLIComp_JOH_IA32_1_b;
   11 : StrLICompFunction := StrLIComp_JOH_IA32_1_c;
   12 : StrLICompFunction := StrLIComp_JOH_IA32_1_d;
   13 : StrLICompFunction := StrLIComp_JOH_IA32_2_a;
   14 : StrLICompFunction := StrLIComp_JOH_IA32_2_b;
   15 : StrLICompFunction := StrLIComp_JOH_IA32_2_c;
   16 : StrLICompFunction := StrLIComp_JOH_IA32_2_d;
 else
...
begin
 ReportRichEdit.Print('StrLIComp Report');
end;
