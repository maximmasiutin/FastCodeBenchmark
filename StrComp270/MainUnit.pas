...
uses
 StrCompRTLUnit, StrCompDKCUnit, Math, FastcodeCPUID, SystemInfoUnit, StrCompDFLUnit, StrCompRCUnit,
 StrCompShaUnit, StrCompJOHUnit;

{$R *.dfm}

type
 TStrCompFunction = function (const Str1, Str2:PChar): Integer;

var
 StrCompFunction : TStrCompFunction;
...
const
 ...
 NOOFRERUNS : Cardinal = 7;//Must be at least 2 //Reruns
...
begin
 ...
 Str2Array[0] := #0;
 Str2Array[1] := #0;
 I1 := StrComp(Str1, Str2);
 I2 := StrCompFunction(Str1, Str2);
      ...
      begin
       ...
       for I2 := 1 to SUBBENCH1STRARRAYSIZE-2 do
        begin
         ...
         J1 := StrCompFunction(Str1, Str2);
         J2 := StrCompFunction(Str2, Str1);
        end;
      end;
    end;
   Succes := QueryPerformanceCounter(lpPerformanceCount);
...
begin
 try
  ...
  FunctionAddress := Cardinal(@StrCompFunction);
...
begin
 case FunctionSelectionRadioGroup.ItemIndex+1 of
   1 : StrCompFunction := StrComp_RTL_IA32_1_a;
   2 : StrCompFunction := StrComp_RTL_IA32_1_b;
   3 : StrCompFunction := StrComp_RTL_IA32_1_c;
   4 : StrCompFunction := StrComp_RTL_IA32_1_d;
   5 : StrCompFunction := StrComp_RC_IA32_1_a;
   6 : StrCompFunction := StrComp_RC_IA32_1_b;
   7 : StrCompFunction := StrComp_RC_IA32_1_c;
   8 : StrCompFunction := StrComp_RC_IA32_1_d;
   9 : StrCompFunction := StrComp_DKC_IA32_11_a;
  10 : StrCompFunction := StrComp_DKC_IA32_11_b;
  11 : StrCompFunction := StrComp_DKC_IA32_11_c;
  12 : StrCompFunction := StrComp_DKC_IA32_11_d;
  13 : StrCompFunction := StrComp_DKC_IA32_24_a;
  14 : StrCompFunction := StrComp_DKC_IA32_24_b;
  15 : StrCompFunction := StrComp_DKC_IA32_24_c;
  16 : StrCompFunction := StrComp_DKC_IA32_24_d;
  17 : StrCompFunction := StrComp_DKC_Pas_7_a;
  18 : StrCompFunction := StrComp_DKC_Pas_7_b;
  19 : StrCompFunction := StrComp_DKC_Pas_7_c;
  20 : StrCompFunction := StrComp_DKC_Pas_7_d;
  21 : StrCompFunction := StrComp_Sha_IA32_3_a;
  22 : StrCompFunction := StrComp_Sha_IA32_3_b;
  23 : StrCompFunction := StrComp_Sha_IA32_3_c;
  24 : StrCompFunction := StrComp_Sha_IA32_3_d;
  25 : StrCompFunction := StrComp_DFL_Pas_6_a;
  26 : StrCompFunction := StrComp_DFL_Pas_6_b;
  27 : StrCompFunction := StrComp_DFL_Pas_6_c;
  28 : StrCompFunction := StrComp_DFL_Pas_6_d;
  29 : StrCompFunction := StrComp_Sha_IA32_4_a;
  30 : StrCompFunction := StrComp_Sha_IA32_4_b;
  31 : StrCompFunction := StrComp_Sha_IA32_4_c;
  32 : StrCompFunction := StrComp_Sha_IA32_4_d;
  33 : StrCompFunction := StrComp_Sha_IA32_5_a;
  34 : StrCompFunction := StrComp_Sha_IA32_5_b;
  35 : StrCompFunction := StrComp_Sha_IA32_5_c;
  36 : StrCompFunction := StrComp_Sha_IA32_5_d;
  37 : StrCompFunction := StrComp_Sha_Pas_4_a;
  38 : StrCompFunction := StrComp_Sha_Pas_4_b;
  39 : StrCompFunction := StrComp_Sha_Pas_4_c;
  40 : StrCompFunction := StrComp_Sha_Pas_4_d;
  41 : StrCompFunction := StrComp_Sha_Pas_5_a;
  42 : StrCompFunction := StrComp_Sha_Pas_5_b;
  43 : StrCompFunction := StrComp_Sha_Pas_5_c;
  44 : StrCompFunction := StrComp_Sha_Pas_5_d;
  45 : StrCompFunction := StrComp_Sha_IA32_7_a;
  46 : StrCompFunction := StrComp_Sha_IA32_7_b;
  47 : StrCompFunction := StrComp_Sha_IA32_7_c;
  48 : StrCompFunction := StrComp_Sha_IA32_7_d;
  49 : StrCompFunction := StrComp_Sha_IA32_8_a;
  50 : StrCompFunction := StrComp_Sha_IA32_8_b;
  51 : StrCompFunction := StrComp_Sha_IA32_8_c;
  52 : StrCompFunction := StrComp_Sha_IA32_8_d;
  53 : StrCompFunction := StrComp_JOH_PAS_2_a;
  54 : StrCompFunction := StrComp_JOH_PAS_2_b;
  55 : StrCompFunction := StrComp_JOH_PAS_2_c;
  56 : StrCompFunction := StrComp_JOH_PAS_2_d;
  57 : StrCompFunction := StrComp_JOH_IA32_5_a;
  58 : StrCompFunction := StrComp_JOH_IA32_5_b;
  59 : StrCompFunction := StrComp_JOH_IA32_5_c;
  60 : StrCompFunction := StrComp_JOH_IA32_5_d;
  61 : StrCompFunction := StrComp_JOH_IA32_6_a;
  62 : StrCompFunction := StrComp_JOH_IA32_6_b;
  63 : StrCompFunction := StrComp_JOH_IA32_6_c;
  64 : StrCompFunction := StrComp_JOH_IA32_6_d;
 else
