...
uses
 StrICompDKCUnit, Math, FastcodeCPUID, SystemInfoUnit, StrICompJOHUnit, AboutUnit, StrICompDFL;

{$R *.dfm}

type
 TStrICompFunction = function (const Str1, Str2:PChar): Integer;

var
 StrICompFunction : TStrICompFunction;
...
const
 ...
 SUBBENCH2STRARRAYSIZE : Cardinal = 300;
 ...
 NOOFRERUNS : Cardinal = 8;//Must be at least 2 //Reruns
 MAXNOOFRUNS : Cardinal = 3000;
 SUBBENCH2MAXNOOFRUNS : Cardinal = 10;
...
procedure ErrorTrap(ValidateNo : Cardinal;  Str1, Str2 : PChar);
begin
 StrICompFunction(Str1, Str2);
 if MainForm.ShowErrorDialogCheckBox.Checked then
  Application.MessageBox(PChar('Function failed in Validate' + IntToStr(ValidateNo) + ' String1: ' + Str1 + ' String2: ' + Str2), 'Error');
end;
...
try
 ...
 Str2Array[0] := #0;
 Str2Array[1] := #0;
 I1 := StrIComp(Str1, Str2);
 I2 := StrICompFunction(Str1, Str2);
 if Sign(I1) <> Sign(I2) then
  begin
   ErrorTrap(VALIDATENO, Str1, Str2);
   Result := False;
   Exit;
  end;
 Str1 := Str1Array;
            ...
            begin
             for J7 := 0 to 255 do
              begin
               ...
               Str1Array[5] := Char(J2);
               Str1Array[6] := Char(J1);
               I1 := StrICompFunction(Str1, Str1);
               if I1 <> 0 then
                begin
                 ErrorTrap(VALIDATENO, Str1, Str1);
                 Result := False;
                 Exit;
                end;
              end;
      ...
      begin
       ...
       for I2 := 1 to SUBBENCH1STRARRAYSIZE-2 do
        begin
         ...
         J1 := StrICompFunction(Str1, Str2);
         J2 := StrICompFunction(Str2, Str1);
        end;
      end;
    end;
   Succes := QueryPerformanceCounter(lpPerformanceCount);
...
begin
 try
  ...
  FunctionAddress := Cardinal(@StrICompFunction);
...
begin
 case FunctionSelectionRadioGroup.ItemIndex+1 of
  1 : StrICompFunction := StrIComp; {64 Bytes}
  2 : StrICompFunction := StrIComp_DKC_Pas_6_a;
  3 : StrICompFunction := StrIComp_DKC_Pas_6_b;
  4 : StrICompFunction := StrIComp_DKC_Pas_6_c;
  5 : StrICompFunction := StrIComp_DKC_Pas_6_d;
  6 : StrICompFunction := StrIComp_DKC_IA32_10_a;
  7 : StrICompFunction := StrIComp_DKC_IA32_10_b;
  8 : StrICompFunction := StrIComp_DKC_IA32_10_c;
  9 : StrICompFunction := StrIComp_DKC_IA32_10_d;
  10 : StrICompFunction := StrIComp_DKC_IA32_15_a;
  11 : StrICompFunction := StrIComp_DKC_IA32_15_b;
  12 : StrICompFunction := StrIComp_DKC_IA32_15_c;
  13 : StrICompFunction := StrIComp_DKC_IA32_15_d;
  14 : StrICompFunction := StrIComp_JOH_PAS_1_a;
  15 : StrICompFunction := StrIComp_JOH_PAS_1_b;
  16 : StrICompFunction := StrIComp_JOH_PAS_1_c;
  17 : StrICompFunction := StrIComp_JOH_PAS_1_d;
  18 : StrICompFunction := StrIComp_JOH_IA32_1_a;
  19 : StrICompFunction := StrIComp_JOH_IA32_1_b;
  20 : StrICompFunction := StrIComp_JOH_IA32_1_c;
  21 : StrICompFunction := StrIComp_JOH_IA32_1_d;
  22 : StrICompFunction := StrIComp_JOH_IA32_2_a;
  23 : StrICompFunction := StrIComp_JOH_IA32_2_b;
  24 : StrICompFunction := StrIComp_JOH_IA32_2_c;
  25 : StrICompFunction := StrIComp_JOH_IA32_2_d;
  26 : StrICompFunction := StrIComp_JOH_IA32_3_a;
  27 : StrICompFunction := StrIComp_JOH_IA32_3_b;
  28 : StrICompFunction := StrIComp_JOH_IA32_3_c;
  29 : StrICompFunction := StrIComp_JOH_IA32_3_d;
  30 : StrICompFunction := StrIComp_JOH_IA32_4_a;
  31 : StrICompFunction := StrIComp_JOH_IA32_4_b;
  32 : StrICompFunction := StrIComp_JOH_IA32_4_c;
  33 : StrICompFunction := StrIComp_JOH_IA32_4_d;
  34 : StrICompFunction := StrIComp_DFL_Pas_10_a;
  35 : StrICompFunction := StrIComp_DFL_Pas_10_b;
  36 : StrICompFunction := StrIComp_DFL_Pas_10_c;
  37 : StrICompFunction := StrIComp_DFL_Pas_10_d;
  38 : StrICompFunction := StrIComp_DFL_Pas_11_a;
  39 : StrICompFunction := StrIComp_DFL_Pas_12_a;
  40 : StrICompFunction := StrIComp_DFL_Pas_18_a;
  41: StrICompFunction := StrIComp_DFL_Pas_19_a;
  42: StrICompFunction := StrIComp_DFL_Pas_19_b;
  43: StrICompFunction := StrIComp_DFL_Pas_19_c;
  44: StrICompFunction := StrIComp_DFL_Pas_19_d;
  45 : StrICompFunction := StrIComp_DKC_IA32_16_a;
  46 : StrICompFunction := StrIComp_DKC_IA32_16_b;
  47 : StrICompFunction := StrIComp_DKC_IA32_16_c;
  48 : StrICompFunction := StrIComp_DKC_IA32_16_d;
  49 : StrICompFunction := StrIComp_DKC_IA32_17_a;
  50 : StrICompFunction := StrIComp_DKC_IA32_17_b;
  51 : StrICompFunction := StrIComp_DKC_IA32_17_c;
  52 : StrICompFunction := StrIComp_DKC_IA32_17_d;
  53 : StrICompFunction := StrIComp_DKC_IA32_18_a;
  54 : StrICompFunction := StrIComp_DKC_IA32_18_b;
  55 : StrICompFunction := StrIComp_DKC_IA32_18_c;
  56 : StrICompFunction := StrIComp_DKC_IA32_18_d;
 else
