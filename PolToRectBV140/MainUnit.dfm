object MainForm: TMainForm
  Left = 149
  Top = 98
  Caption = 'PolToRect Benchmark & Validation Tool for Fastcode Version 1.4.0'
  ClientHeight = 566
  ClientWidth = 842
  Color = clBtnFace
  ...
  object ExtendedFunctionSelectionRadioGroup: TRadioGroup
    ...
    Items.Strings = (
      ...
      'PolToRectDKCIA32_2'
      'PolToReg_FO_IA32_1'
      'PolToRect_PLR_IA32_1'
      'PolToRect_PLR_IA32_2'
      'PolToRect_PLR_PAS_1'
      'PolToRect_JOH_IA32_1'
      'PolToRect_JOH_PAS_1')
    TabOrder = 9
