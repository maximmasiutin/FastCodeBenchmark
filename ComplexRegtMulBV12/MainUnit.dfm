object MainForm: TMainForm
  ...
  Height = 612
  Caption = 
    'Complex Number Regtangular Multiplication Benchmark & Validation' +
    ' Tool for Fastcode Version 1.2'
  Color = clBtnFace
  ...
  object SSE2PrecisionCheckBox: TCheckBox
    Left = 168
    Top = 512
    Width = 97
    Height = 17
    Caption = 'SSE2PrecisionCheckBox'
    TabOrder = 28
  end
