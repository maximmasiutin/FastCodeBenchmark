...
type
  TMainForm = class(TForm)
    ...
    SSE2PrecisionCheckBox: TCheckBox;
...
uses
 ComplexDataTypesUnit, Math, RegtMulDKCUnit, RectMul_JOH;
...
const
 ...
 MAXVALIDATESINGLE2 : Single = 1E17;
 VALIDATESINGLE2STEPSIZE : Single = 13;
 ...
 //SSE2 limits
 VALIDATEDOUBLE2STEPSIZE_SSE2 : Double = 12345;
 MAXVALIDATEDOUBLE_SSE2 : Double = 1E5;
 MINVALIDATEDOUBLE_SSE2 : Double = 1E-5;
 DOUBLELIMIT_SSE2 : Double = 1E-1;
 //IA 32 Limits
 VALIDATEDOUBLE2STEPSIZE : Double = 123456789;
 MAXVALIDATEDOUBLE2 : Double = 1E150;
 MINDOUBLE : Double = 5E-324;
 MAXDOUBLE : Double = 1.7E308;
 DOUBLELIMIT : Double = 1E-15;

type
 TRegtMulExtendedFunction = function (const X, Y : TRegtangularComplexE) : TRegtangularComplexE;
 TRegtMulDoubleFunction = function (const X, Y : TRegtangularComplexD) : TRegtangularComplexD;
 TRegtMulSingleFunction = function (const X, Y : TRegtangularComplexS) : TRegtangularComplexS;
...
var
 ...
 RegtMulExtendedFunction : TRegtMulExtendedFunction;
 RegtMulDoubleFunction : TRegtMulDoubleFunction;
 RegtMulSingleFunction : TRegtMulSingleFunction;
...
begin
 ...
 Y.RealPart := 3;
 Y.ImaginaryPart := 4;
 Z := RegtMulExtendedFunction(X, Y);
 if not((Z.RealPart = -5) and (Z.ImaginaryPart = 10)) then
  begin
   Result := False;
   Exit;
  end;
 ...
 Y.ImaginaryPart := 1;
 Z := RegtMulExtendedFunction(X, Y);
 if not((Z.RealPart = 0) and (Z.ImaginaryPart = 2)) then
  begin
   Result := False;
   Exit;
  end;
 ...
 Y.ImaginaryPart := 3;
 Z := RegtMulExtendedFunction(X, Y);
 if not ((Z.RealPart = -3) and (Z.ImaginaryPart = 2)) then
  begin
   Result := False;
  end;
end;
     ...
     while X.ImaginaryPart < MAXVALIDATEEXTENDED2 do
      begin
       ...
       while X.RealPart < MAXVALIDATEEXTENDED2 do
        begin
         Z1 := RegtMulDKCPas1(X, Y);
         Z2 := RegtMulExtendedFunction(X, Y);
         if (Z1.RealPart <> 0) and (Z1.ImaginaryPart <> 0) then
          begin
...
begin
 ...
 try
  ...
  Y.RealPart := MAXEXTENDED;
  Y.ImaginaryPart := MAXEXTENDED;
  Z := RegtMulExtendedFunction(X, Y);
 except
  Result := True;
 end;
...
begin
 Result := True;
 Y.ImaginaryPart := MINVALIDATEDOUBLE_SSE2;
 while Y.ImaginaryPart < MAXVALIDATEDOUBLE_SSE2 do
  begin
   Y.RealPart := MINVALIDATEDOUBLE_SSE2;
   while Y.RealPart < MAXVALIDATEDOUBLE_SSE2 do
    begin
     X.ImaginaryPart := MINVALIDATEDOUBLE_SSE2;
     while X.ImaginaryPart < MAXVALIDATEDOUBLE_SSE2 do
      begin
       X.RealPart := MINVALIDATEDOUBLE_SSE2;
       while X.RealPart < MAXVALIDATEDOUBLE_SSE2 do
        begin
         Z1 := RegtMulDKCPas1(X, Y);
         Z2 := RegtMulDoubleFunction(X, Y);
         if (Abs(Z1.RealPart) <> 0) and (Abs(Z1.ImaginaryPart) <> 0) then
          begin
...
begin
 ...
 try
  ...
  Y.RealPart := MAXDOUBLE;
  Y.ImaginaryPart := MAXDOUBLE;
  Z := RegtMulDoubleFunction(X, Y);
 except
  Result := True;
 end;
...
begin
 ...
 while Y.ImaginaryPart < MAXVALIDATEDOUBLE2 do
  begin
   Y.RealPart := MINDouble;
   while Y.RealPart < MAXVALIDATEDOUBLE2 do
    begin
     X.ImaginaryPart := MINDOUBLE;
     while X.ImaginaryPart < MAXVALIDATEDOUBLE2 do
      begin
       X.RealPart := MINDouble;
       while X.RealPart < MAXVALIDATEDOUBLE2 do
        begin
         Z1 := RegtMulDKCPas1(X, Y);
         Z2 := RegtMulDoubleFunction(X, Y);
         if (Z1.RealPart <> 0) and (Z1.ImaginaryPart <> 0) then
...
begin
 ...
 try
  ...
  Y.RealPart := MAXSINGLE;
  Y.ImaginaryPart := MAXSINGLE;
  Z := RegtMulSingleFunction(X, Y);
 except
  Result := True;
 end;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtMulExtendedFunction);
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub1BenchmarkArray[I5]
        := RegtMulExtendedFunction(ExtendedSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub1BenchmarkArray[I5]
        := RegtMulDoubleFunction(DoubleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub1BenchmarkArray[I5]
        := RegtMulSingleFunction(SingleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub2BenchmarkArray[I5]
        := RegtMulExtendedFunction(ExtendedSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub2BenchmarkArray[I5]
        := RegtMulDoubleFunction(DoubleSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub2BenchmarkArray[I5]
        := RegtMulSingleFunction(SingleSrc1Sub2BenchmarkArray[I5],
...
begin
 case ExtendedFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtMulExtendedFunction := RegtMulDKCPas1;
  1 : RegtMulExtendedFunction := RegtMulDKCIA32_1;
  2 : RegtMulExtendedFunction := RectMul_JOH_IA32;
 else
...
begin
 ...
 SaveDialog.FileName := 'ComplexRegtMulBenchReport.Txt';
...
begin
 case DoubleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtMulDoubleFunction := RegtMulDKCPas1;
  1 : RegtMulDoubleFunction := RegtMulDKCIA32_1;
  2 : RegtMulDoubleFunction := RegtMulDKCIA32_2;
  3 : RegtMulDoubleFunction := RectMul_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 case SingleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtMulSingleFunction := RegtMulDKCPas1;
  1 : RegtMulSingleFunction := RegtMulDKCIA32_1;
  2 : RegtMulSingleFunction := RectMul_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtMulDoubleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtMulSingleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
