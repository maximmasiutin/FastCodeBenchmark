unit CompareTextShaUnit;

interface

function CompareText_Sha_Pas_5_a(const S1, S2: string): Integer;
function CompareText_Sha_Pas_5_b(const S1, S2: string): Integer;
function CompareText_Sha_Pas_5_c(const S1, S2: string): Integer;
function CompareText_Sha_Pas_5_d(const S1, S2: string): Integer;
function CompareText_Sha_IA32_3_a(const S1, S2: string): Integer;
function CompareText_Sha_IA32_3_b(const S1, S2: string): Integer;
function CompareText_Sha_IA32_3_c(const S1, S2: string): Integer;
function CompareText_Sha_IA32_3_d(const S1, S2: string): Integer;
function CompareText_Sha_IA32_4_a(const S1, S2: string): integer;
function CompareText_Sha_IA32_4_b(const S1, S2: string): integer;
function CompareText_Sha_IA32_4_c(const S1, S2: string): integer;
function CompareText_Sha_IA32_4_d(const S1, S2: string): integer;
