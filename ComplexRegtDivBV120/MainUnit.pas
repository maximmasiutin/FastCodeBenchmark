...
uses
 ComplexDataTypesUnit, FastcodeCPUID, SystemInfoUnit, Math, RegtDivDKCUnit, RectDiv_JOH;
...
const
 ...
 MAXVALIDATEEXTENDED2 : Extended = 1E2500;
 VALIDATEEXTENDED2STEPSIZE : Extended = 1E125;
 MINVALIDATESINGLE2 : Single = 1E-18;
 MAXVALIDATESINGLE2 : Single = 1E18;
 VALIDATESINGLE2STEPSIZE : Single = 9;
...
type
 TRegtDivExtendedFunction = function (const X, Y : TRegtangularComplexE) : TRegtangularComplexE;
 TRegtDivDoubleFunction = function (const X, Y : TRegtangularComplexD) : TRegtangularComplexD;
 TRegtDivSingleFunction = function (const X, Y : TRegtangularComplexS) : TRegtangularComplexS;
...
var
 ...
 RegtDivExtendedFunction : TRegtDivExtendedFunction;
 RegtDivDoubleFunction : TRegtDivDoubleFunction;
 RegtDivSingleFunction : TRegtDivSingleFunction;
...
begin
 ...
 Y.RealPart := 1;
 Y.ImaginaryPart := 1;
 Z := RegtDivExtendedFunction(X, Y);
 if not((Z.RealPart = 1) and (Z.ImaginaryPart = 0)) then
  begin
   Result := False;
   Exit;
  end;
...
begin
 ...
 while Y.ImaginaryPart < MAXVALIDATEEXTENDED2 do
  begin
   Y.RealPart := MINEXTENDED;
   while Y.RealPart < MAXVALIDATEEXTENDED2 do
    begin
     ...
     while X.ImaginaryPart < MAXVALIDATEEXTENDED2 do
      begin
       ...
       while X.RealPart < MAXVALIDATEEXTENDED2 do
        begin
         if ((Y.RealPart * Y.RealPart + Y.ImaginaryPart * Y.ImaginaryPart) <> 0) then
          begin
           Z1 := RegtDivDKCPas1(X, Y);
           Z2 := RegtDivExtendedFunction(X, Y);
           if ((Z1.RealPart <> 0) and
               (Z1.ImaginaryPart <> 0)) then
            begin
             if (Abs((Z1.RealPart - Z2.RealPart) / Z1.RealPart) > EXTENDEDLIMIT) or
                (Abs((Z1.ImaginaryPart - Z2.ImaginaryPart) / Z1.ImaginaryPart) > EXTENDEDLIMIT) then
              begin
               Result := False;
               Exit;
              end;
...
begin
 Result := True;
 Y.ImaginaryPart := MINDOUBLE_SSE2;
 while Y.ImaginaryPart < MAXVALIDATEDOUBLE2_SSE2 do
  begin
   Y.RealPart := MINDOUBLE_SSE2;
   while Y.RealPart < MAXVALIDATEDOUBLE2_SSE2 do
    begin
       ...
       while X.RealPart < MAXVALIDATEDOUBLE2_SSE2 do
        begin
         if (Y.RealPart * Y.RealPart + Y.ImaginaryPart * Y.ImaginaryPart) <> 0 then
          begin
           Z1 := RegtDivDKCPas1(X, Y);
           Z2 := RegtDivDoubleFunction(X, Y);
           if ((Z1.RealPart <> 0) and
               (Z1.ImaginaryPart <> 0)) then
            begin
             if (Abs((Z1.RealPart - Z2.RealPart) / Z1.RealPart) > DOUBLELIMIT_SSE2) or
                (Abs((Z1.ImaginaryPart - Z2.ImaginaryPart) / Z1.ImaginaryPart) > DOUBLELIMIT_SSE2) then
              begin
               Result := False;
               Exit;
              end;
     ...
     Y.RealPart := Y.RealPart * VALIDATEDOUBLE2STEPSIZE_SSE2;
    end;
   Y.ImaginaryPart := Y.ImaginaryPart * VALIDATEDOUBLE2STEPSIZE_SSE2;
  end;
end;
...
begin
 Result := True;
 Y.ImaginaryPart := MINVALIDATEDOUBLE6;
 while Y.ImaginaryPart < MAXVALIDATEDOUBLE6 do
  begin
   Y.RealPart := MINVALIDATEDouble6;
   while Y.RealPart < MAXVALIDATEDOUBLE6 do
    begin
         ...
         if (Y.RealPart * Y.RealPart + Y.ImaginaryPart * Y.ImaginaryPart) <> 0 then
          begin
           ...
           if ((Z1.RealPart <> 0) and
               (Z1.ImaginaryPart <> 0)) then
            begin
             if (Abs((Z1.RealPart - Z2.RealPart) / Z1.RealPart) > DOUBLELIMIT) or
                (Abs((Z1.ImaginaryPart - Z2.ImaginaryPart) / Z1.ImaginaryPart) > DOUBLELIMIT) then
              begin
               Result := False;
               Exit;
              end;
...
begin
 Result := True;
 Y.ImaginaryPart := MINVALIDATESINGLE2;
 while Y.ImaginaryPart < MAXVALIDATESINGLE2 do
  begin
   Y.RealPart := MINVALIDATESINGLE2;
   while Y.RealPart < MAXVALIDATESINGLE2 do
    begin
       ...
       while X.RealPart < MAXVALIDATESINGLE2 do
        begin
         if (Y.RealPart * Y.RealPart + Y.ImaginaryPart * Y.ImaginaryPart) <> 0 then
          begin
           Z1 := RegtDivDKCPas1(X, Y);
           Z2 := RegtDivSingleFunction(X, Y);
           if ((Z1.RealPart <> 0) and
               (Z1.ImaginaryPart <> 0)) then
            begin
             if (Abs((Z1.RealPart - Z2.RealPart) / Z1.RealPart) > SINGLELIMIT) or
                (Abs((Z1.ImaginaryPart - Z2.ImaginaryPart) / Z1.ImaginaryPart) > SINGLELIMIT) then
              begin
               Result := False;
               Exit;
              end;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtDivExtendedFunction);
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub1BenchmarkArray[I5]
        := RegtDivExtendedFunction(ExtendedSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub1BenchmarkArray[I5]
        := RegtDivDoubleFunction(DoubleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub1BenchmarkArray[I5]
        := RegtDivSingleFunction(SingleSrc1Sub1BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       ExtendedResultSub2BenchmarkArray[I5]
        := RegtDivExtendedFunction(ExtendedSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       DoubleResultSub2BenchmarkArray[I5]
        := RegtDivDoubleFunction(DoubleSrc1Sub2BenchmarkArray[I5],
     ...
     for I5 := 0 to BENCHARRAYSIZE-1 do
      begin
       SingleResultSub2BenchmarkArray[I5]
        := RegtDivSingleFunction(SingleSrc1Sub2BenchmarkArray[I5],
...
begin
 ...
 ReportRichEdit.Paragraph.Tab[2] := 165;
 ReportRichEdit.Paragraph.Tab[3] := 200;
 ReportRichEdit.Paragraph.Tab[4] := 235;
 ...
 for J1 := 0 to BENCHARRAYSIZE-1 do
  begin
   ExtendedSrc2Sub2BenchmarkArray[J1].RealPart := J1+1;
   ExtendedSrc2Sub2BenchmarkArray[J1].ImaginaryPart := J1+1;
  end;
 for J2 := 0 to BENCHARRAYSIZE-1 do
  begin
   DoubleSrc2Sub2BenchmarkArray[J2].RealPart := J2+1;
   DoubleSrc2Sub2BenchmarkArray[J2].ImaginaryPart := J2+1;
  end;
 for J3 := 0 to BENCHARRAYSIZE-1 do
  begin
   SingleSrc2Sub2BenchmarkArray[J3].RealPart := J3+1;
   SingleSrc2Sub2BenchmarkArray[J3].ImaginaryPart := J3+1;
  end;
...
begin
 case ExtendedFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtDivExtendedFunction := RegtDivDKCPas1;
  1 : RegtDivExtendedFunction := RegtDivDKCPas2;
  2 : RegtDivExtendedFunction := RegtDivDKCPas3;
  3 : RegtDivExtendedFunction := RegtDivDKCIA32_1;
  4 : RegtDivExtendedFunction := RegtDivDKCIA32_2;
  5 : RegtDivExtendedFunction := RegtDivDKCIA32_3;
  6 : RegtDivExtendedFunction := RectDiv_JOH_IA32;
 else
...
begin
 case DoubleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtDivDoubleFunction := RegtDivDKCPas1;
  1 : RegtDivDoubleFunction := RegtDivDKCPas2;
  2 : RegtDivDoubleFunction := RegtDivDKCPas3;
  3 : RegtDivDoubleFunction := RegtDivDKCIA32_1;
  4 : RegtDivDoubleFunction := RegtDivDKCIA32_2;
  5 : RegtDivDoubleFunction := RegtDivDKCIA32_3;
  6 : RegtDivDoubleFunction := RectDiv_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 case SingleFunctionSelectionRadioGroup.ItemIndex of
  0 : RegtDivSingleFunction := RegtDivDKCPas1;
  1 : RegtDivSingleFunction := RegtDivDKCPas2;
  2 : RegtDivSingleFunction := RegtDivDKCPas3;
  3 : RegtDivSingleFunction := RegtDivDKCIA32_1;
  4 : RegtDivSingleFunction := RegtDivDKCIA32_2;
  5 : RegtDivSingleFunction := RegtDivDKCIA32_3;
  6 : RegtDivSingleFunction := RectDiv_JOH_IA32;
 else
  raise Exception.Create('Invalid Function Number');
 end;
end;
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtDivDoubleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
  if ValidateDouble1 and
     ValidateDouble2 and
     ValidateDouble3 and
     ValidateDouble4 and
     ValidateDouble6 and //IA32 Validation. SSE2 will not pass this
...
begin
 try
  ...
  FunctionAddress := Cardinal(@RegtDivSingleFunction);
  FunctionAddressString := IntToHex(FunctionAddress, 8);
