...
uses
 Math, FastCodeCPUID, SystemInfoUnit, Ceil32DKCUnit, Ceil32RefUnit, AboutUnit, Ceil32PLRUnit,
  Ceil32JOHUnit, Ceil32LBGUnit;

const
 NOOFRERUNS : Cardinal = 6;
 RUNNOMAX : Cardinal = 10000;
...
type
 TCeil32SingleFunction = function (const X : Single) : Integer;
 TCeil32DoubleFunction = function (const X : Double) : Integer;
 TCeil32ExtendedFunction = function (const X : Extended) : Integer;
...
var
 Ceil32SingleFunction : TCeil32SingleFunction;
 Ceil32DoubleFunction : TCeil32DoubleFunction;
 Ceil32ExtendedFunction : TCeil32ExtendedFunction;
   ...
   begin
    ...
    for RunNo := 1 to RUNNOMAX do
     for I := 0 to BENCHARRAYSIZE-1 do
      I1 := Ceil32ExtendedFunction(BenchArrayExtended[I].X);
    Succes := QueryPerformanceCounter(lpPerformanceCount);
    if Succes then
 ...
 try
  ...
  for ReRunNo := 1 to NOOFRERUNS do
   begin
    ...
    for RunNo := 1 to RUNNOMAX do
     for I := 0 to BENCHARRAYSIZE-1 do
      I1 := Ceil32DoubleFunction(BenchArrayDouble[I]);
    Succes := QueryPerformanceCounter(lpPerformanceCount);
    if Succes then
     EndCount := lpPerformanceCount
    else
 ...
 try
  ...
  for ReRunNo := 1 to NOOFRERUNS do
   begin
    ...
    for RunNo := 1 to RUNNOMAX do
     for I := 0 to BENCHARRAYSIZE-1 do
      I1 := Ceil32SingleFunction(BenchArraySingle[I]);
    Succes := QueryPerformanceCounter(lpPerformanceCount);
    if Succes then
     EndCount := lpPerformanceCount
    else
...
begin
 ReportRichEdit.Print('Ceil32 Report');
end;
...
begin
 case FunctionExtendedSelectionRadioGroup.ItemIndex+1 of
  1 : Ceil32ExtendedFunction := Ceil;
  2 : Ceil32ExtendedFunction := Ceil32_DKC_Pas_1;
  3 : Ceil32ExtendedFunction := Ceil32_DKC_Pas_3;
  4 : Ceil32ExtendedFunction := Ceil32_DKC_Pas_4;
  5 : Ceil32ExtendedFunction := Ceil32_DKC_Pas_5;
  6 : Ceil32ExtendedFunction := Ceil32_DKC_IA32_1;
  7 : Ceil32ExtendedFunction := Ceil32_PLR_IA32_1;
  8 : Ceil32ExtendedFunction := Ceil32_PLR_IA32_2;
  9 : Ceil32ExtendedFunction := Ceil32_PLR_PAS_1;
  10 : Ceil32ExtendedFunction := Ceil32_JOH_PAS_1;
  11 : Ceil32ExtendedFunction := Ceil32_JOH_IA32_1;
  12 : Ceil32ExtendedFunction := Ceil32_LBG_PAS_1;
 else
...
begin
 case FunctionDoubleSelectionRadioGroup.ItemIndex+1 of
  1 : Ceil32DoubleFunction := Ceil32_DKC_Pas_1;
  2 : Ceil32DoubleFunction := Ceil32_DKC_Pas_3;
  3 : Ceil32DoubleFunction := Ceil32_DKC_Pas_4;
  4 : Ceil32DoubleFunction := Ceil32_DKC_Pas_5;
  5 : Ceil32DoubleFunction := Ceil32_DKC_IA32_1;
  6 : Ceil32DoubleFunction := Ceil32_DKC_SSE2_1;
  7 : Ceil32DoubleFunction := Ceil32_DKC_SSE2_2;
  8 : Ceil32DoubleFunction := Ceil32_DKC_SSE2_3;
  9 : Ceil32DoubleFunction := Ceil32_DKC_SSE2_4;
  10 : Ceil32DoubleFunction := Ceil32_DKC_SSE2_5;
  11 : Ceil32DoubleFunction := Ceil32_PLR_IA32_1;
  12 : Ceil32DoubleFunction := Ceil32_PLR_IA32_2;
  13 : Ceil32DoubleFunction := Ceil32_JOH_PAS_1;
  14 : Ceil32DoubleFunction := Ceil32_JOH_IA32_1;
 else
  raise Exception.Create('Invalid function selected');
 end;
end;
...
begin
 case FunctionSingleSelectionRadioGroup.ItemIndex+1 of
  1 : Ceil32SingleFunction := Ceil32_DKC_Pas_1;
  2 : Ceil32SingleFunction := Ceil32_DKC_Pas_3;
  3 : Ceil32SingleFunction := Ceil32_DKC_Pas_4;
  4 : Ceil32SingleFunction := Ceil32_DKC_Pas_5;
  5 : Ceil32SingleFunction := Ceil32_DKC_IA32_1;
  6 : Ceil32SingleFunction := Ceil32_DKC_IA32_2;
  7 : Ceil32SingleFunction := Ceil32_DKC_IA32_3;
  8 : Ceil32SingleFunction := Ceil32_DKC_IA32_4;
  9 : Ceil32SingleFunction := Ceil32_DKC_SSE_1;
  10 : Ceil32SingleFunction := Ceil32_PLR_IA32_1;
  11 : Ceil32SingleFunction := Ceil32_PLR_IA32_2;
  12 : Ceil32SingleFunction := Ceil32_JOH_PAS_1;
  13 : Ceil32SingleFunction := Ceil32_JOH_IA32_1;
  14 : Ceil32SingleFunction := Ceil32_LBG_PAS_1;
 else
  raise Exception.Create('Invalid function selected');
 end;
end;
