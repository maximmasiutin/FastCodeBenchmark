...
begin
  Result := (A * B) div (1 shl 9); // seems to be converted to SAR by D7 fine.
end;

procedure InverseDCT_NH_Pas_2_a(const Coef: TsdCoefBlock; const Quant : TsdIntArray64; out Sample: TsdSampleBlock; var  Wrksp: TsdIntArray64);
var
  i, QIdx: integer;
  dci: integer;
  dcs: byte;
...
MainForm.RegisterFunction('InverseDCT_NH_Pas_2_a', @InverseDCT_NH_Pas_2_a);
